...
import logoIMG from './assets2/NewLogo.png';
    ...
    <footer class="bg-transparent">
        ...
        >
            ...
            <div>
                ...
                {/* //render logo here */}
                    <img src={logoIMG} alt='Power Pause' className=' object-cover h-30 w-20' />
                </div>

                <p class="mt-4 max-w-xs text-white">
                Power Pause, a platform designed to optimize your naps and exercises, enhancing overall productivity and well-being
                </p>
